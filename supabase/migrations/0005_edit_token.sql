...
-- ----------------------------------------------------------------------------
-- 1. עמודת הטוקן הסודי. לשורות קיימות מייצרים טוקן אקראי חד-פעמי (hex).
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 2. שכתוב get_countdown — חובה להחריג את edit_token מהקריאה הציבורית!
...
-- ----------------------------------------------------------------------------
-- 3. שליפת הספירה לעריכה לפי הטוקן הסודי בלבד (לא לפי slug).
...
-- ----------------------------------------------------------------------------
-- 4. עדכון ספירה לפי הטוקן. מחזיר את ה-slug בהצלחה, או NULL אם הטוקן שגוי.
